...
type ReviewRequest = { weekStart?: string; budgetRemaining?: number | null; diningOutPlan?: string; wantedFoods?: string; avoidFoods?: string; note?: string; pantry?: PantryDraft[] };
